                    ...
                    PrefilterRuleStore *pmq, const uint8_t *buf, const uint32_t buflen, Packet *p)
{
    ...
    SCLogDebug("Hyperscan search with %" PRIu32 " patterns on buf %p of length %d", pd->pattern_cnt, buf, buflen);
    ...
    SCLogDebug("Hyperscan search found %" PRIu32 " matches", ret);
